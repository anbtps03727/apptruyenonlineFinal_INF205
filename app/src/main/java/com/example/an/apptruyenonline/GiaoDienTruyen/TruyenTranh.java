...
import com.example.an.apptruyenonline.Adapter.TruyenTranhAdapter;
...
public class TruyenTranh extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.truyentranh_fragment, container, false);
    ...
    class AddJsonIntoList extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                adapter = new TruyenTranhAdapter(getActivity(), list);
